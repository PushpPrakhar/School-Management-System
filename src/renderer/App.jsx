...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    label: "Collect Fees",
    icon: "💰",
    permission: "feesReceipt",
  },
  {
    key: "feesNotice",
    label: "Fees Notice",
    icon: "📢",
    permission: "feesNotice",
  },
  {
    key: "admitCard",
    label: "Admit Cards",
    icon: "🪪",
    permission: "admitCard",
  },
  {
    key: "attendance",
    label: "Attendance",
  ...
  },
  {
    ...
    label: "Examination",
    icon: "📊",
    permission: "examMarks",
  },
  {
    key: "tcGeneration",
    label: "TC Generation",
    icon: "📄",
    permission: "tcGeneration",
  },
  {
    key: "backup",
...
function AppShell() {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case "dashboard":
        return <ComingSoon page="Dashboard — Phase 6" />;
      // Phase 2+
      case "admission":
        return <ComingSoon page="Admission Form — Phase 2" />;
      case "studentList":
        return <ComingSoon page="Student List — Phase 2" />;
      case "feesReceipt":
        return <ComingSoon page="Fees Receipt — Phase 3" />;
      case "feesNotice":
        return <ComingSoon page="Fees Notice — Phase 3" />;
      case "admitCard":
        return <ComingSoon page="Admit Card — Phase 4" />;
      case "tcGeneration":
        return <ComingSoon page="TC Generation — Phase 4" />;
      case "attendance":
        return <ComingSoon page="Attendance — Phase 5" />;
      case "examination":
        return <ComingSoon page="Examination — Phase 5" />;
      case "backup":
        return <ComingSoon page="Backup & Restore — Phase 6" />;
      case "users":
...
function UserManagement() {
  ...
  return (
    <div>
      ...
      {msg && (
        <div
          className={`mb-4 p-3 rounded-lg text-sm ${msg.includes("success") ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
        >
          {msg}
        </div>
      )}
      ...
      {showForm && (
        <form
          ...
          className="bg-white border border-gray-200 rounded-xl p-5 mb-6 grid grid-cols-2 gap-4"
        >
          <div>
          ...
          {form.role === "teacher" && (
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, assigned_class: e.target.value })
                }
